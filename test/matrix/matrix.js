...
function mergeAnomalies(item1Anomalies, item2Anomalies) {
 ...
 function createDriverBtn(div, driver) {
    let button = document.createElement('button');
    button.className = 'driver-btn';
    button.id = 'driver-' + driver.nom.toLowerCase();
    button.onclick = () => {
        setDriver(driver.nom);
    };
 ...
 function createCarteBtn(div, carte) {
    let button = document.createElement('button');
    button.className = 'carte-btn';
    button.id = 'driver-' + carte.nom.toLowerCase();
    button.onclick = () => {
        setDriver(carte.nom);
    };
